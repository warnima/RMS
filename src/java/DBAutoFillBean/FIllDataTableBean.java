...
public class FIllDataTableBean {
    ...
    private String _strData;
     ...
     public String getPDCVerificationSummeryData(String _system_date) {
        TableDAO tdo = new TableDAO();
        return tdo.getPDCVerificationSummeryData(_system_date);

    }
     public String getPDCNotVerifiedChequeSummeryData(String _system_date) {
        TableDAO tdo = new TableDAO();
        return tdo.getPDCNotVerifiedChequeSummeryData(_system_date);
      ...
      public String getHolidayData(String user_id) {
       ...
       public String getCWPDCData(String user_id) {
        ...
        TableDAO tdo = new TableDAO();
        return tdo.getPdcVdeElqUnauthData(user_id);
