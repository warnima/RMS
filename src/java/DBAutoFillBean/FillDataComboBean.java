...
public class FillDataComboBean {
    ...
    public String getCust_Id_ActiveRFSellerDataCmbAll(String user_id) {
        comboDAO tcmbodo = new comboDAO();
        return tcmbodo.getCust_Id_ActiveRFSellerDataCmbAll(user_id);

    }

//    public String getCust_Id_AllRFSellerDataCmb(String user_id) {
//        comboDAO tcmbodo = new comboDAO();
//        return tcmbodo.getCust_Id_AllRFSellerDataCmb(user_id);
//
//    }
    ...
    public String getCust_Id_ActiveCWRFSellerDataCmb(String user_id) {
        comboDAO tcmbodo = new comboDAO();
        return tcmbodo.getCust_Id_ActiveCWRFSellerDataCmb(user_id);
    ...
    public String getCust_Name_ActiveRFSellerDataCmbAll(String user_id) {
        comboDAO tcmbodo = new comboDAO();
        return tcmbodo.getCust_Name_ActiveRFSellerDataCmbAll(user_id);

    }

    public String getCust_Name_ActiveCWRFSellerDataCmb(String user_id) {
        comboDAO tcmbodo = new comboDAO();
        return tcmbodo.getCust_Name_ActiveCWRFSellerDataCmb(user_id);
    ...
    public String getSellerBuyserCount() {
        comboDAO tcmbodo = new comboDAO();
        return tcmbodo.getSellerBuyserCount();

    }

    public String getActiveChequesCount() {
        comboDAO tcmbodo = new comboDAO();
        return tcmbodo.getActiveChequesCount();

    }

    public String getActiveChqAmount() {
        comboDAO tcmbodo = new comboDAO();
        return tcmbodo.getActiveChqAmount();

    }

    public String getTodayProcessChqsCount() {
        comboDAO tcmbodo = new comboDAO();
        return tcmbodo.getTodayProcessChqsCount();
