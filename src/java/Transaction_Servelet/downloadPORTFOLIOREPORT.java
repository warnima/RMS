 ...
 * @author Madhawa_4799
 */
@WebServlet(name = "downloadPORTFOLIOREPORT", urlPatterns = {"/downloadPORTFOLIOREPORT"})
public class downloadPORTFOLIOREPORT extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         try {
            ...
            String txn_auth_status = request.getParameter("txn_status");
            String file_extention=".csv";
            
            String out_put = depositSLIPS.downloadPortFolioReport(_system_date, user_id, file_extention,txn_auth_status);
