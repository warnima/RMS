 ...
 * @author Madhawa_4799
 */
@WebServlet(name = "downloadTodayBookedDEPOSITSLIPS", urlPatterns = {"/downloadTodayBookedDEPOSITSLIPS"})
public class downloadUAUTHDATA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String user_id = session.getAttribute("userid").toString().toUpperCase();
            String _system_date = new comboDAO().getSystemDate();
            String idndb_customer_define_seller_id = request.getParameter("txn_seller");
            String pdc_type = request.getParameter("txn_type");
            String txn_bulk = request.getParameter("txn_bulk");
            String out_put = depositSLIPS.downloadUNAUTHREPORT(_system_date, idndb_customer_define_seller_id, pdc_type, user_id,txn_bulk);
            ...
            e.printStackTrace();
            response.sendRedirect("pages/pdc_txns/modalsError.jsp?desigURL=ndb_pdc_fileupld.jsp&message="+e.getLocalizedMessage()+"");
        }
    }
