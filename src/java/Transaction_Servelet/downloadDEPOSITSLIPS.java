 ...
 * @author Madhawa_4799
 */
@WebServlet(name = "downloadDEPOSITSLIPS", urlPatterns = {"/NDBRMS//downloadDEPOSITSLIPS"})
public class downloadDEPOSITSLIPS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String booked_date = request.getParameter("value_date");
            ...
            String out_put =depositSLIPS.downloadChqSendingDeposiSlips(booked_date,idndb_customer_define_seller_id,PDCBulkUploadFileRFData,PDCBulkUploadFileCWData);
            ...
            m_result.put("success", "Successfully Saved");
             ...
             response.sendRedirect("pages/pdc_txns/modalsError.jsp?desigURL=ndb_cheque_sending.jsp&message=" + e.getLocalizedMessage() + "");
            e.printStackTrace();
        }
    }
