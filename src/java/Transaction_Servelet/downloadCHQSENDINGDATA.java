...
public class downloadCHQSENDINGDATA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String txn_value_date = request.getParameter("txn_value_date");
            String out_put = depositSLIPS.downloadCLEARINGAUTHREPORT(_system_date, idndb_customer_define_seller_id, pdc_type, user_id,txn_value_date);
            ...
            response.sendRedirect("pages/RMSreports/modalsError.jsp?desigURL=ndb_cheque_sending.jsp&message=" + e.getLocalizedMessage() + "");
            e.printStackTrace();
        }
    }
