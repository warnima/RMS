...
<html>
    <head>
        ...
        <title>NDB BANK | CW Received Cheques Status - All (SW)</title>
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    ...
                                    table.row.add([v.seller_cust_id, v.seller_cust_name, v.buyer_cust_id, v.buyer_cust_name, v.pdc_booking_date, v.pdc_value_date, v.pdc_chq_number, v.pdc_bank_code, v.pdc_branch_code, v.pdc_chq_amu, v.current_status, v.pdc_chq_wh_dr_to_cr_spe_narr, v.pdc_reference_1, v.pdc_reference_2, v.pdc_reference_3, v.pdc_reference_4, v.pdc_reference_5]).draw();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'CW_RECEIVED_CHEQUES_STATUS_SW.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'CW_RECEIVED_CHEQUES_STATUS_SW.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        CW Received Cheques Status - All (SW)
                        <small>CW Received Cheques Status - All (SW)</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">CW Received Cheques Status - All (SW)</h3>
                                </div><!-- /.box-header -->
