...
<html>
    <head>
        ...
        <title>NDB BANK | CW Cheque Return Analysis (BW) Report </title>
        ...
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#idndb_customer_define_buyer_id')
                                    .empty()
                                    .append('<option selected="selected" value="all">All Buyer</option>')
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_pdc_cw_rurned_anal_bw";
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'CW_CHEQUE_RETURN_ANALYSIS_BW.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'CW_CHEQUE_RETURN_ANALYSIS_BW.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        CW Cheque Return Analysis - (BW) Report
                        <small>CW Cheque Return Analysis - (BW) Report</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">CW Cheque Return Analysis - (BW) Report</h3>
                                </div><!-- /.box-header -->
