...
<html>
    <head>
        ...
        <title>NDB BANK | CW Cheque Status Report</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#status").change(function () {
                ...
                if (!($("#status").val() === 'Select The Status')) {
                    $('#status').css('border-color', '');
                } else {
                    $('#status').css('border-color', 'red');
                    swal("Invalid Input !", "Please select the status. !", "error");
                }
            ...
            $("#date_type").change(function () {
                ...
                if (!($("#date_type").val() === 'Select The Date Type')) {
                    $('#date_type').css('border-color', '');
                } else {
                    $('#date_type').css('border-color', 'red');
                    swal("Invalid Input !", "Please select the date type. !", "error");
                }
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    ...
                                    table.row.add([v.seller_cust_id, v.seller_cust_name, v.buyer_cust_id, v.buyer_cust_name, v.pdc_booking_date, v.pdc_value_date, v.pdc_chq_number, v.pdc_bank_code, v.pdc_branch_code, v.pdc_chq_amu, v.pdc_chq_discounting_amu, v.current_status, v.pdc_chq_wh_dr_to_cr_spe_narr, v.pdc_reference_1, v.pdc_reference_2, v.pdc_reference_3, v.pdc_reference_4, v.pdc_reference_5]).draw();
            ...
            function validateInput() {
                ...
                if (status === 'Select The Status') {
                    $('#status').css('border-color', 'red');
                    hasError = false;
                }
                if (date_type === 'Select The Date Type') {
                    $('#date_type').css('border-color', 'red');
                    hasError = false;
                }
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'RF_CHEQUES_STATUS.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'RF_CHEQUES_STATUS.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        CW Cheque Status Report
                        <small>CW Cheque Status Report Data</small>
                    </h1>
                            ...
                            <div class="box">
                                <form class="form-horizontal" onsubmit="return validateInput()">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Cheque Status</label>
                                            <div class="col-sm-10">
                                                <select class="form-control" id="status" style="width: 350px;">
                                                    <option>Select The Status</option>
                                                    <option value="AUTHORIZED">AUTHORIZED</option>
                                                    <option value="UN-AUTHORIZED">UN-AUTHORIZED</option>
                                                    <option value="ACTIVE">ACTIVE</option>
                                                    <option value="DEACTIVE">DEACTIVE</option>
                                                    <option value="RETURNED">RETURNED</option>
                                                    <option value="ERLYLIQUDED">LIQUIDATED</option>
                                                    <option value="PROCESSED">CLEARED</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="date_type" style="width: 350px;">
                                                    <option>Select The Date Type</option>
                                ...
                                <div class="box-footer">
                                    ...
                                    <form class="form-horizontal" action="/NDBRMS/downloadUAUTHDATA" onsubmit="return validateReportInput()">
                                        ...
                                        <input type="hidden" class="form-control" id="txn_bulk" name="txn_bulk" value="INPUTTER" style="width: 350px">
                                        <button type="submit" class="btn btn-info pull-right" style="margin-right: 0.5%;">Download PDF (UN-Authorized Data only)</button>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">CW Cheque Status Report Data</h3>
                                </div><!-- /.box-header -->
