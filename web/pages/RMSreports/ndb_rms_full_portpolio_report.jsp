...
<html>
    <head>
        ...
        <title>NDB BANK | Portfolio Report</title>
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_full_portpolio_reort";
                    var values = "&status=" + $("#status").val().trim() +
                            "&paramid=" + paramid;
                    //alert(values);
                    $.ajax({
                        type: "POST",
                        ...
                        success: function (data) {
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    table.row.add([v.pdc_req_financing, v.cust_name_seller, v.cust_id_seller, v.cust_name, v.cust_id, v.pdc_booking_date, v.pdc_value_date, v.pdc_chq_number, v.pdc_bank_code, v.pdc_branch_code, v.pdc_chq_amu, v.pdc_chq_discounting_amu, v.current_status, v.seller_officer]).draw();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'RFCHQPORTFOLIO.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', date + ' RFCHQPORTFOLIO.xls');
            }
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="submit" class="btn btn-info pull-right" id="proccess" style="margin-right: 0.5%;">&nbsp;&nbsp;View&nbsp;&nbsp;</button>
                                </div>

                            </div><!-- /.box -->

                            <div class="box-body">
                                <form class="form-horizontal" action="/NDBRMS/downloadPORTFOLIOREPORT" onsubmit="return validateInput()">
                                    <div class="form-group">

                                        <input type="hidden" class="form-control" id="txn_status" name="txn_status" value="AUTHORIZED"  style="width: 350px">
                                    </div>
                                    <div class="box-footer" style="margin-top: -17px;width: 1004px;margin-left: -10px;">
                                        <button type="submit" class="btn btn-info pull-right">Download Report</button>
                                    </div>
