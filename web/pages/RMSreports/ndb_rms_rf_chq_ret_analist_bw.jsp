...
<html>
    <head>
        ...
        <title>NDB BANK | RF Cheque Return Analysis (BW) Report</title>
        ...
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#idndb_customer_define_buyer_id')
                                    .empty()
                                    .append('<option selected="selected" value="all">All Buyers</option>')
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_pdc_rf_rurned_anal_bw";
...
//                        type: "POST",
                        ...
                        success: function (data) {
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    table.row.add([v.cust_name_seller, v.cust_id_seller, v.cust_name_buyer, v.cust_id_buyer, v.sent_to_clearing, v.processed_chqs, v.return_from_clearing, v.sent_to_present, v.return_from_present, v.seller_officer]).draw();
                                });
                                $("#loading-mask").hide();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'RF_CHEQUE_RETURN_ANALYSIS_BW.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'RF_CHEQUE_RETURN_ANALYSIS_BW.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        RF Cheque Return Analysis - (BW) Report
                        <small>RF Cheque Return Analysis - (BW) Report</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <form class="form-horizontal">
                                    <!--<form class="form-horizontal" action="/NDBRMS/report_data_extract" onsubmit="return validateInput()">-->
                                    <!--<input type="hidden" class="form-control" id="paramid" name="paramid" value="get_sellers_buyer_data_for_rms">-->
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">RF Cheque Return Analysis - (BW) Report</h3>
                                </div><!-- /.box-header -->
