...
<html>
    <head>
        ...
        <title>NDB BANK | RF Cheque Return Analysis - (SW) Report</title>       <!-- Tell the browser to be responsive to screen width -->
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_pdc_rf_rurned_anal";
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    ...
                                    table.row.add([v.cust_name_seller, v.cust_id_seller, v.sent_to_clearing, v.processed_chqs, v.return_from_clearing, v.sent_to_present, v.return_from_present, v.seller_officer]).draw();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'RF_CHEQUE_RETURN_ANALYSIS_SW.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'RF_CHEQUE_RETURN_ANALYSIS_SW.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        RF Cheque Return Analysis - (SW) Report
                        <small>RF Cheque Return Analysis - (SW) Report</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">RF Cheque Return Analysis - (SW) Report </h3>
                                </div><!-- /.box-header -->
