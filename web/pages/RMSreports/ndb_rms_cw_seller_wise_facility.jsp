...
<html>
    <head>
        ...
        <title>NDB BANK | CW Dealer Facility Summary Report</title>
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_pdc_cw_seller_wise_facility";
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    ...
                                    table.row.add([v.idndb_cust_prod_map, v.cust_id_seller, v.cust_name_seller, v.seller_chq_ware_housing_limit, v.total_seller_outstanding, v.seller_chq_ware_housing_lavailability, v.seller_officer]).draw();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'CW_DEALER_FACILITY_SUMMERY_REPORT.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'CW_DEALER_FACILITY_SUMMERY_REPORT.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        CW Dealer Facility - Summary Report
                        <small>CW Dealer Facility - Summary Report</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">CW Dealer Facility - Summary Report</h3>
                                </div><!-- /.box-header -->
