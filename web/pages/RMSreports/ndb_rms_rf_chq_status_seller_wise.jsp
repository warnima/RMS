...
<html>
    <head>
        ...
        <title>NDB BANK | RF Cheque Status Report</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    ...
                                    table.row.add([v.seller_cust_id, v.seller_cust_name, v.buyer_cust_id, v.buyer_cust_name, v.pdc_booking_date, v.pdc_value_date, v.pdc_chq_number, v.pdc_bank_code, v.pdc_branch_code, v.pdc_chq_amu, v.pdc_chq_discounting_amu, v.current_status, v.pdc_reference_1, v.pdc_reference_2, v.pdc_reference_3, v.pdc_reference_4, v.pdc_reference_5]).draw();
            ...
            function validateInput() {
                ...
                if (!hasError) {
                    $("#loading-mask").hide();
                    swal("Invalid Inputs !", "please look intohighlighted error inputs.. !", "error");
                    hasError = false;
                }
                return hasError;
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        RF Cheque Status Report
                        <small>RF Cheque Status Report Data</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">RF Cheque Status Report Data</h3>
                                </div><!-- /.box-header -->
