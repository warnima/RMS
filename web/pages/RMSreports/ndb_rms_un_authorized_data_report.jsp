...
<html>
    <head>
        ...
        <title>NDB BANK | RMS Un-Authorized Data Report</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            window.onload = function () {
                ...
                var paramid = "get_all_un_auth_data";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if ((Object.keys(data).length) === 0) {
                            $("#loading-mask").hide();
                            swal("No records !", "Un-authorized records not found. !");
                        } else {
                            $("#div_report_table").show();
                            $.each(data, function (k, v) {
                                table.row.add([v.module, v.module_id, v.modification, v.mod_by, v.mod_time]).draw();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'ALL_UNAUTHORIZED_DATA.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'ALL_UNAUTHORIZED_DATA.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        RMS Un-Authorized Data Report
                        <small>RMS Un-Authorized data</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">RMS Un-Authorized data</h3>
                                </div><!-- /.box-header -->
