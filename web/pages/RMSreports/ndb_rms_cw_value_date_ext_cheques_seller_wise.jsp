...
<html>
    <head>
        ...
        <title> NDB BANK | CW Value Date Extn Cheques Report</title>
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "getPdcValueDateExtentionedChequesSellerWise";
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    ...
                                    table.row.add([v.seller_cust_id, v.seller_cust_name, v.buyer_cust_name, v.buyer_cust_id, v.pdc_booking_date, v.pdc_old_value_date, v.pdc_value_date, v.pdc_chq_number, v.pdc_bank_code, v.pdc_branch_code, v.pdc_chq_amu, v.current_status, v.pdc_chq_wh_dr_to_cr_spe_narr, v.pdc_reference_1, v.pdc_reference_2, v.pdc_reference_3, v.pdc_reference_4, v.pdc_reference_5]).draw();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, file_name + 'CWVALDATEEXT.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', file_name + 'CWVALDATEEXT.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        PDC CW Value Date Extension Report
                        <small>PDC CW Value Date Extension Data</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="submit" class="btn btn-info pull-right" id="proccess">View</button>
                                </div>
                                <hr>
                            </div><!-- /.box -->
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">PDC CW Value Date Extension Data</h3>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Buyer Name</th>                                                
                                                <th>Booked Date</th>
                                                <th>Old Value Date</th>
                                                <th>Extended Value Date</th>
                                                <th>Chq. Number</th>
                                                <th>Bank Code</th>
                                                <th>Branch Code</th>
                                                <th>Chq Amount.</th>
