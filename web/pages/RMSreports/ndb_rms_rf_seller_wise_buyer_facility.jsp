...
<html>
    <head>
        ...
        <title>NDB BANK | RF Dealer Facility Detail Report </title>
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_pdc_rf_seller_wise_buyer_facility";
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    ...
                                    table.row.add([v.cust_name_seller, v.cust_id_seller, v.cust_name_buyer, v.cust_id_buyer, v.shb_facty_det_crd_loam_limit_percentage, v.shb_facty_det_crd_loam_limit, v.pdc_chq_amu, v.available_amu, v.seller_officer]).draw();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'RF_DEALER_FACILITY_DETAIL_REPORT.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'RF_DEALER_FACILITY_DETAIL_REPORT.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        RF Dealer Facility - Detail Report
                        <small> RF Dealer Facility - Detail Report</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"> RF Dealer Facility - Detail Report</h3>
                                </div><!-- /.box-header -->
