...
<html>
    <head>
        ...
        <title>NDB BANK | CW Seller Commission Charges Report</title>
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_pdc_cw_commsion_chrges";
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    table.row.add([v.cust_name_seller, v.cust_id_seller, v.scomm_chg, v.seller_officer]).draw();
                                });
                                $("#loading-mask").hide();
                            }
                        }
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'CW_SELLER_COMMISSION_CHARGES.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'CW_SELLER_COMMISSION_CHARGES.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        CW Seller Commission charges -Report
                        <small>CW Seller Commission charges Data</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">CW Seller Commission charges Report</h3>
                                </div><!-- /.box-header -->
