...
<html>
    <head>
        ...
        <title>NDB BANK | RF Cheque Return Analysis (SW) Report </title>
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_pdc_cw_rurned_anal";
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'CW_CHEQUE_RETURN_ANALYSIS_SW.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'CW_CHEQUE_RETURN_ANALYSIS_SW.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        CW Cheque Return Analysis - (SW) Report
                        <small>CW Cheque Return Analysis - (SW) Report</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">CW Cheque Return Analysis - (SW) Report</h3>
                                </div><!-- /.box-header -->
