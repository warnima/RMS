...
<html>
    <head>
        ...
        <title>NDB BANK | CW Dealer Facility Detail Report</title>
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_pdc_cw_seller_wise_buyer_facility";
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    ...
                                    table.row.add([v.cust_name_seller, v.cust_id_seller, v.cust_name_buyer, v.cust_id_buyer, v.sl_has_byr_warehs_limit_percentage, v.sl_has_byr_warehs_limit, v.pdc_chq_amu, v.available_amu, v.seller_officer]).draw();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, 'CWSELLERVSBUYERFAC.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'CW_DEALER_FACILITY_DETAIL_REPORT.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        CW Dealer Facility - Detail Report
                        <small>CW Dealer Facility - Detail Report</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">CW Dealer Facility - Detail Report</h3>
                                </div><!-- /.box-header -->
