...
<html>
    <head>
        ...
        <title>NDB BANK | Find Buyer ID's Report</title>
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_seller_buyer_key_data";
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    table.row.add([v.idndb_seller_has_buyers, v.seller_id, v.seller_name, v.buyer_id, v.buyer_name, v.buyer_status]).draw();
                                });
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, date + 'SELLER_BUYER_RELATIONSHIP_DATA.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'SELLER_BUYER_RELATIONSHIP_DATA.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Find Buyer ID's
                        <small>Seller Buyer Relationship Data</small>
                    </h1>
