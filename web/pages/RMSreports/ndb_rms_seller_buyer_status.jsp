...
<html>
    <head>
        ...
        <title>NDB BANK | Seller Buyer Status Report</title>
        ...
        $(function () {
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_seller_buyer_status_data";
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    table.row.add([v.customer_difine_seller_id, v.customer_difine_seller_name,v.branch_name_seller ,v.customer_difine_buyer_id, v.customer_difine_buyer_name, v.customer_difine_seller_status, v.customer_difine_buyer_status, v.customer_prod_map_seller_status, v.customer_prod_map_buyer_status, v.customer_relship_sellerBuyer_status]).draw();
                                });
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, date + 'SELLER_BUYER_STATUS_DATA.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', 'SELLER_BUYER_STATUS_DATA.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Find Seller Buyer Status
                        <small>Seller Buyer Status Data</small>
                    </h1>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Seller Buyer Relationship Key Data</h3>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Buyer ID</th>
                                                <th>Buyer Name</th>
                                                <th>Customer Define Seller Status</th>
                                                <th>Customer Define Buyer Status</th>
                                                <th>Customer Product Mapping Seller Status</th>
                                                <th>Customer Product Mapping Buyer Status</th>
                                                <th>Relationship Establishment Status</th>
                                            </tr>
                                        </thead>
                                        <tbody>
