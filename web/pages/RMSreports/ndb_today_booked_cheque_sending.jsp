...
<html>
    <head>
        ...
        <title>NDB BANK | Discounted Cheques Slips Download</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#idndb_customer_define_seller_id')
                                    .empty()
                                    .append('<option value="Select The Seller">Select The Seller</option>')
            ...
            $("#proccess").click(function (e) {
                ...
                if (validateInput()) {
                    ...
                    var paramid = "get_today_booked_cheque_sending";
                    var values = "&booked_date=" + booked_date +
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if ((Object.keys(data).length) === 0) {
                                ...
                                $.each(data, function (k, v) {
                                    table.row.add([v.rec_count, v.pdc_relationship, v.seller, v.buyer, v.pdc_chq_number, v.pdc_bank_code, v.pdc_branch_code, v.pdc_chq_amu]).draw();
                                });
                                $("#loading-mask").hide();
        ...
        function validateInput() {
            ...
            var req_for_financing = 'NOTDIFINE';
            ...
            if (req_for_financing === 'NOTDIFINE') {
            ...
            if (PDCBulkUploadFileData === '') {
                ...
                $('#PDCBulkUploadFileData').css('border-color', 'red');
                $("#loading-mask").hide();
                return false;
            }
            var booked_date = $("#booked_date").val();
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, date + 'DISCOUNTED_CHEQUES_SLIPS.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', date + 'DISCOUNTED_CHEQUES_SLIPS.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Discounted Cheques Slips Download
                        <small>Discounted Cheques Slips Download Data</small>
                    </h1>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <form class="form-horizontal" action="/NDBRMS/downloadTodayBookedDEPOSITSLIPS" onsubmit="return validateInput()">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" id="booked_date" name="booked_date" data-mask style="width: 325px" value="<%=_system_date%>">
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-info pull-right" id="down_slips" onclick="validateInput()">&nbsp;&nbsp;Download SLIPS&nbsp;&nbsp;</button>
                                    </div>
                                    <!-- /.box-footer -->
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Discounted Cheques Slips Download Data</h3>
                                </div><!-- /.box-header -->
