...
<html>
    <head>
        ...
        <title>NDB BANK | Txn Success</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#button_close").click(function (e) {
                ...
                window.location = "" + desigURL + "?id_seller=" + id_seller + "";
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Data Saved Success</h4>
                                    </div>
                                    <div class="modal-body">
                                        <p><%= request.getParameter("message")%></p>
                                    </div>
                                    <div class="modal-footer">
                                        <input type="hidden" name="desig_url" id="desig_url" value="<%= request.getParameter("desigURL")%>" />
                                        <input type="hidden" name="id_seller" id="id_seller" value="<%= request.getParameter("id_seller")%>" />
