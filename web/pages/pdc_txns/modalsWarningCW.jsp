...
<html>
    <head>
        ...
        <title>NDB BANK | Modals Warning CW</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#cw_pdc_save_changes").click(function (e) {

                document.getElementById("cw_pdc_save_changes").disabled = true;
                ...
                var values = "&idndb_customer_define_seller_id=" + $("#idndb_customer_define_seller_id").val().trim() +
                        ...
                        "&cw_cheque_amu=" + $("#cw_cheque_amu").val().trim() +
                        "&chq_wh_dr_to_cr_spe_narr=" + $("#chq_wh_dr_to_cr_spe_narr").val().trim() +
                        "&cw_cheque_modification=" + $("#cw_cheque_modification").val().trim() +
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p><%= request.getParameter("message")%><%= request.getParameter("action")%></br></p>
                                    </div>
                                    <div class="modal-footer"><input type="hidden" name="desig_url" id="desig_url" value="<%= request.getParameter("desigURL")%>" />
                                        ...
                                        <input type="hidden" name="desig_url" id="cw_chq_number" value="<%= request.getParameter("cw_chq_number")%>" />
                                        ...
                                        <input type="hidden" name="desig_url" id="cw_value_date" value="<%= request.getParameter("cw_value_date")%>" />
                                        <input type="hidden" name="desig_url" id="cw_cheque_amu" value="<%= request.getParameter("cw_cheque_amu")%>" />
                                        <input type="hidden" name="desig_url" id="chq_wh_dr_to_cr_spe_narr" value="<%= request.getParameter("chq_wh_dr_to_cr_spe_narr")%>" />
                                        <input type="hidden" name="desig_url" id="cw_cheque_modification" value="<%= request.getParameter("cw_cheque_modification")%>" />
                                        ...
                                        <button type="button" class="btn btn-outline" id="cw_pdc_save_changes">Save changes</button>
                                    </div>
                                </div><!-- /.modal-content -->
                            </div><!-- /.modal-dialog -->
                        </div><!-- /.modal -->
