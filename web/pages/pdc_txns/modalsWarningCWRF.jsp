...
<html>
    <head>
        ...
        <title>NDB BANK | Modals Warning RF</title>
            ...
            $("#fr_pdc_save_changes").click(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            window.location = "modalsSucess.jsp?desigURL=ndb_pdc_cw_rf_conversion.jsp&message=PDC cheque warehousing entry conversion to receviable finance data saved to System successfuly and sent for authorization.";

                        } else if (data.systemna) {
                            window.location = "modalsError.jsp?desigURL=ndb_pdc_cw_rf_conversion.jsp&message=" + data.systemna + "";

                        } else if (data.error) {
                            window.location = "modalsError.jsp?desigURL=ndb_pdc_cw_rf_conversion.jsp&message=PDC Entry Already Exists !";

                        } else if (data.cn_error) {
                            window.location = "modalsError.jsp?desigURL=ndb_pdc_cw_rf_conversion.jsp&message=Error occured in cheque warehosing entry conversion to receviable finance entry !";
