...
<html>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#rf_chq_number").keyup(function () {
                if (!(this.value === '')) {
                    $('#rf_chq_number').css('border-color', '');
                }
            });

            $("#rf_chq_number").focusout(function () {
            ...
            $("#rf_cheque_amu").keyup(function () {
                ...
                if (!(this.value === '')) {
                    $('#rf_cheque_amu').css('border-color', '');
                }
            });
            ...
            $("#btn_pdc_unauth_view").click(function (e) {
                ...
                if (!(idndb_customer_define_seller_id === 'Select The Seller')) {
                    ...
                    var values = "idndb_customer_define_seller_id=" + idndb_customer_define_seller_id + "\
                        &selection_param=RF_NEW&paramid=" + paramid;
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if ((Object.keys(data).length) === 0) {
                                $("#loading-mask").hide();
                                swal("No data found !", "Un-Authorized RF new transactions not available. !");
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (k, v) {
                                ...
                                if (v.m_buyer_acc_dtails_availability === true && v.m_buyer_acc_dtails_validity === false) {
                                    ...
                                    window.location = "modalsError.jsp?desigURL=ndb_pdc_rf_manual.jsp&message=" + buyer_bank_branch_error + "&id_seller=" + $("#idndb_customer_define_seller_id").val().trim() + "";
                                    ...
                                    var defined_pdc_tenor = $("#sl_has_byr_rms_tenor").val();
...
//                                            "&cust_branch_code=" + $('#cust_branch_code').text().trim() +
                                                ...
                                                "&rf_cheque_amu=" + rf_cheque_amu +
                                                "&rf_cheque_modification=NEW&paramid=" + paramid;
            ...
            $("#rf_value_date").focusout(function () {
                ...
                $('#rf_value_date').css('border-color', '');
                $('#rf_value_date_lable').text('');
                ...
                if (obj_current_date.getTime() >= obj_entered_date.getTime()) {
                    ...
                    $('#rf_value_date_lable').text('     Value date cannot be today or backdated date');
                    ...
                    $('#rf_value_date').css('border-color', 'red');
                    $('#rf_value_date_lable').text('Tenor exceeded by ' + pdc_tenor_diff + ' days.');
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-footer" style="padding-top: 3%;">
                                    ...
                                    <button type="button" class="btn btn-info pull-right" id="btn_rf_pdc_save" name="btn_holiday_save" style="margin-right: 0.5%;">Submit</button>
                                </div><!-- /.box-footer -->
