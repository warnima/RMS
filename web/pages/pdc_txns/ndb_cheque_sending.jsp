...
<html>
    <head>
        ...
        <title>NDB BANK | Cheque Sending</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            window.onload = function () {
                ...
                document.getElementById("value_date").disabled = true;
            ...
            $("#proccess").click(function (e) {
                ...
                if (!(value_date === '')) {
                    ...
                    var paramid = "get_today_cheque_sending";
                    var values = "&value_date=" + value_date + "&paramid=" + paramid;
                    $.ajax({
                        type: "POST",
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (k, v) {
                                ...
                                table.row.add([v.idndb_pdc_txn_master, v.seller, v.buyer, v.pdc_chq_number, v.pdc_bank_code, v.pdc_branch_code, v.pdc_chq_amu]).draw();
                    ...
                    $('#value_date').css('border-color', 'red');
                }
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
                if (window.navigator.msSaveBlob) {
                    ...
                    navigator.msSaveBlob(blob, date + 'CLEARINGCHQS.xls');
                }
            } else {
                $('#test').attr('href', data_type + ', ' + encodeURIComponent(tab_text));
                $('#test').attr('download', date + 'CLEARINGCHQS.xls');
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Today Cheque Sending
                        <small>Cheque Sending Data</small>
                    </h1>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-info pull-right" id="btnExport">Cancel</button>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Today Cheque Sending Data</h3>
                                </div><!-- /.box-header -->
