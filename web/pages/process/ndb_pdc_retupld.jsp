...
<html>
    <head>
        ...
        <title>NDB BANK | Return Upload</title>
    ...
    <script>
        ...
        function validateInput() {
            ...
            var hasError = true;
            var ReturnFileData = $("#ReturnFileData").val();

            if (ReturnFileData === '') {


                window.location = "modalsError.jsp?desigURL=ndb_pdc_retupld.jsp&message=Invalid Return file.Please pick the correct return file !";
//                $('#ReturnFileData').css('border-color', 'red');
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Return file Upload
                        <small>Return file Upload</small>
                    </h1>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <form class="form-horizontal" method="POST"  action="/NDBRMS/ReturnFileUpload" enctype="multipart/form-data" style="padding-left: 20px" onsubmit="return validateInput()">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Return File input</label>
                                            <input type="file" id="ReturnFileData" name="ReturnFileData" accept=".txt">
                                            <p class="help-block">Pick Return file for upload</p>
                                        </div>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Return File Upload Data</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <%                                                            if ((session.getAttribute("userid") == null) || (session.getAttribute("userid") == "")) {
                                                    ...
                                                    out.print(new FIllDataTableBean().getReturnFileData(session.getAttribute("userid").toString()));
                                                }
                                            %>
                                        </tbody>
                                        <tfoot>
