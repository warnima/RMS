    ...
    <script>
        ...
        $(function () {
            ...
            window.onload = function () {
                $("#day_today").prop('readonly', true);
                $("#day_next").prop('readonly', true);
                $("#loading-mask").hide();
            ...
            $("#btn_day_end_process").click(function (e) {

                $("#btn_day_end_process").prop("disabled", true);
                $("#loading-mask").show();
                var paramid = "mstr_run_day_end_process";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            window.location = "modalsSucess.jsp?desigURL=ndb_pdc_dayend.jsp&message=Day end processes proceed successfully."

                        } else if (data.erroruntr) {
                            window.location = "modalsError.jsp?desigURL=ndb_pdc_dayend.jsp&message=" + data.erroruntr + "";

                        } else if (data.errorretleq) {
                            window.location = "modalsError.jsp?desigURL=ndb_pdc_dayend.jsp&message=" + data.errorretleq + "";

                        } else if (data.errordbbackup) {
                            window.location = "modalsError.jsp?desigURL=ndb_pdc_dayend.jsp&message=" + data.errordbbackup + "";

                        } else if (data.error) {
                            window.location = "modalsError.jsp?desigURL=ndb_pdc_dayend.jsp&message=Error occurred in running day end process ."
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group" style="margin-left: 50px;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask style="width: 325px" id="day_today" value="<%=_system_date%>">
                                            </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                                        <div class="form-group" style="margin-left: 50px;">
                                            <label class="col-sm-2 control-label" style="margin-left: -80px;   ">Next Working Day</label>
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-calendar"></i>
                                                </div>
                                                <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask style="width: 325px" id="day_next" value="<%=m_next_system_date%>">
                                            </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="submit" class="btn btn-info pull-right" id="btn_day_end_process" style="margin-right: 5px">Process</button>
                                </div><!-- /.box-footer -->
                            </div><!-- /.box -->
