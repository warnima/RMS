...
<html>
    <head>
        ...
        <title>NDB BANK | Account Generation</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            window.onload = function () {
                $("#acc_gen_date").prop('readonly', true);
                $("#loading-mask").hide();
            }

            $("#btn_do_process").click(function (e) {
                $("#loading-mask").show();
        ...
        function validateInput() {
            ...
            var hasError = true;
            var acc_gen_date = $("#acc_gen_date").val();


            if (acc_gen_date === '') {

                $('#acc_gen_date').css('border-color', 'red');
                return false;
            }
            $("#btn_do_process").prop("disabled", true);
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        GEFU File Generation
                        <small>GEFU File Generation</small>
                    </h1>
                    <ol class="breadcrumb">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <form class="form-horizontal" action="/NDBRMS/downloadGEFU" onsubmit="return validateInput()">
                                    <div class="box-body">

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label" style="margin-left: -110px;   ">Date</label>
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-calendar"></i>
                                                </div>
                                                <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask style="width: 325px" value="<%=_last_system_date%>" id="acc_gen_date" name="acc_gen_date">
                                            </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-info pull-right" id="cancel_data">Cancel</button>
                                        <button type="submit" class="btn btn-info pull-right" id="btn_do_process" style="margin-right: 5px">Process</button>
                                    </div><!-- /.box-footer -->
                                </form>
                            </div><!-- /.box -->
                        </div><!-- /.box -->
