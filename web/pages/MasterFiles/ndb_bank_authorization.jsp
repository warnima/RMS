...
<html>
    <head>
        ...
        <title>NDB BANK | Bank Master Auth</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#msrt_btn_cancel').click(function () {
                location.reload();
            });
            ...
            $("#msrt_save_bank_auth_data").click(function (e) {
                ...
                $("#msrt_save_bank_auth_data").prop("disabled", true);


                var paramid = "msrt_save_bank_auth_data";
                var values = "&idndb_bank_master_file=" + checkValues +
                        "&paramid=" + paramid;
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            window.location = "modalsSucess.jsp?desigURL=ndb_bank_authorization.jsp&message=Bank data authorized successfuly !";

                        } else if (data.systemna) {
                            window.location = "modalsError.jsp?desigURL=ndb_bank_authorization.jsp&message=" + data.systemna + "";

                        } else if (data.error) {
                            window.location = "modalsError.jsp?desigURL=ndb_bank_authorization.jsp&message=Error occured in authorizing bank data.";
            ...
            $("#msrt_save_bank_reject_data").click(function (e) {
                ...
                $("#msrt_save_bank_reject_data").prop("disabled", true);
                var paramid = "msrt_save_bank_reject_data";
                var values = "&idndb_bank_master_file=" + checkValues +
                        "&paramid=" + paramid;
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            window.location = "modalsSucess.jsp?desigURL=ndb_bank_authorization.jsp&message=Bank data rejected successfuly !";

                        } else if (data.systemna) {
                            window.location = "modalsError.jsp?desigURL=ndb_bank_authorization.jsp&message=" + data.systemna + "";

                        } else if (data.error) {
                            window.location = "modalsError.jsp?desigURL=ndb_bank_authorization.jsp&message=Error occured in rejecting bank data.";
            ...
            function validateInput() {
                ...
                var hasError = true;
                var idndb_bank_master_file = $("#idndb_bank_master_file").val();
                var bank_name = $("#bank_name").val();
                var bank_code = $("#bank_code").val();
                if (idndb_bank_master_file === '') {
                    return false;
                }
                if (bank_name === '') {
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Bank Master File Authorization
                        <small>Bank Data</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Master Files Authorization</a></li>
                        <li class="active">Bank File Authorization</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <form class="form-horizontal" id="bank_form" name="bank_form" action="/NDBRMS/MasterServletFile"> 
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="bank_code" name="bank_code" style="width: 350px">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-info pull-right" id="msrt_save_bank_reject_data">Rejected</button>
                                    <button type="submit" class="btn btn-info pull-right" id="msrt_save_bank_auth_data" style="margin-right: 5px">Authorized</button>
                                    <button type="submit" class="btn btn-info pull-right" id="msrt_btn_cancel" style="margin-right: 5px">Cancel</button>
                                </div><!-- /.box-footer -->
                            </div><!-- /.box -->
                                ...
                                <div class="box-body" style="overflow-y: auto;">
                                    <table id="example1" class="table table-bordered table-striped" style="cursor: pointer;">
                                        ...
                                        <tbody>
                                            <%
                                                if (_session_availability) {
                                                    out.print(new FIllDataTableBean().getUnAuthBankData(session.getAttribute("userid").toString()));
                                                }
                                            %>
                                        </tbody>
                                        <tfoot>
