...
<html>
    <head>
        ...
        <title>NDB BANK | User Levels Forms Master</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btn_user_levels_save").click(function (e) {
                if (validateInput()) {
                    var paramid = "saveroleforms";
                   // alert("ok");
                    var str = $("#form1").serialize();
                   // alert(str);
                    var values = $('#form1').serialize() +
                            "&idndb_user_levels=" + $("#idndb_user_levels").val() +
                            "&paramid=" + paramid;
                   // alert(values);
                    $.ajax({
                        type: "post",
                        url: "/NDBRMS/MenuControler",
                        data: values, //+ '&' + 'paramid='+paramid
                        dataType: "json",
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">User Levels Forms Master File</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">User Levels Forms Data</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
