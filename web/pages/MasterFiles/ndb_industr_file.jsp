...
<html>
    <head>
        ...
        <title>NDB BANK | Industry Master</title>
    ...
    <script type="text/javascript">
        ...
        <% if (user_type.equals("12") || user_type.equals("9") || user_type.equals("10") || user_type.equals("11")) { %>
                $("#industry_id").prop('readonly', true);
                $("#industry_des").prop('readonly', true);
                document.getElementById("industry_status").disabled = true;
                document.getElementById("btn_indsrt_save").disabled = true;
        ...
        <%}  %>
            ...
            $("#btn_indsrt_save").click(function (e) {

                if (validateInput()) {
                    $("#loading-mask").show();

                    $("#btn_indsrt_save").prop("disabled", true);


                    var paramid = "msrt_save_indsrt_data";
                    var values = "&industry_id=" + $("#industry_id").val().trim() +
                            "&industry_des=" + $("#industry_des").val().trim() +
                            "&idndb_industry_master_file=" + $("#idndb_industry_master_file").val().trim() +
                            "&industry_status=" + ($("#industry_status").prop('checked') ? "ACTIVE" : "DEACTIVE") +
                            "&paramid=" + paramid;
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.success) {
                                window.location = "modalsSucess.jsp?desigURL=ndb_industr_file.jsp&message=Industry data saved to DB successfuly.";

                            } else if (data.alreadyexdata) {
                                window.location = "modalsError.jsp?desigURL=ndb_industr_file.jsp&message=Error occured in saving industry data. industry Code allready exist.";

                            } else if (data.systemna) {
                                window.location = "modalsError.jsp?desigURL=ndb_industr_file.jsp&message=" + data.systemna + "";

                            } else if (data.error) {
                                window.location = "modalsError.jsp?desigURL=ndb_industr_file.jsp&message=Error occured in saving industry data.";
            ...
            $('#btn_indsrt_clear').click(function () {
                location.reload();
            });
            ...
            $("#example1 tbody tr").on("click", function (event) {
                ...
                var idndb_industry_master_file = $(this).find("td").eq(0).html();
                var paramid = "get_industry_data_tofill";
                var values = "&idndb_industry_master_file=" + idndb_industry_master_file +
                        "&paramid=" + paramid;
                $.ajax({
                    type: "POST",
                    ...
                    success: function (data) {
                        $.each(data, function (k, v) {
                            ...
                            $("#idndb_industry_master_file").val(v.idndb_industry_master_file);
                            $("#industry_id").val(v.indus_id);
                            $("#industry_des").val(v.indus_des);

                            if (v.indus_status === 'ACTIVE') {
                                $("#industry_status").prop('checked', true);
                            }
                        });
                    }
            ...
            function validateInput() {
                ...
                if (industry_des === '') {
                    $('#industry_des').css('border-color', 'red');
                    return false;
                }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Industry Master File
                        <small>Industry Data</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Master Files</a></li>
                        <li class="active">Industry File</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                                ...
                                <form class="form-horizontal">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="industry_id" name="industry_id" style="width: 350px">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Industry Description</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="industry_des" name="industry_des" style="width: 350px">
                                                <input type="hidden" class="form-control" id="idndb_industry_master_file" name="idndb_industry_master_file" style="width: 350px">
                                            </div>
                                        </div>


                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Industry Status</label>
                                            <div class="col-sm-10">
                                                <input type="checkbox" id="industry_status">Click to Active
                                            </div>
                                        </div>
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-footer">
                                    <a href="../MasterFiles/ndb_industr_file.jsp?table_plus=true" class="btn btn-default btn-flat">View Industry Data</a>
                                    <button type="submit" class="btn btn-info pull-right" id="btn_indsrt_clear">Cancel</button>
                                    <button type="submit" class="btn btn-info pull-right" id="btn_indsrt_save" style="margin-right: 5px">Submit</button>
                                </div><!-- /.box-footer -->
                            </div>
                        </div><!-- /.box -->
                    </div>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Industry Data</h3>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" style="cursor: pointer;" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <%                                                if (_session_availability) {
                                                    ...
                                                    out.print(new FIllDataTableBean().getIndustryData(session.getAttribute("userid").toString()));
                                                }
                                            %>
                                        </tbody>
                                        <tfoot>
