...
<html>
    <head>
        ...
        <title>NDB BANK | Holiday Marker Auth</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            window.onload = function () {
                $("#ndb_holiday").prop('readonly', true);
            ...
            $("#msrt_save_holiday_auth_data").click(function (e) {
                ...
                $("#msrt_save_holiday_auth_data").prop("disabled", true);

                var paramid = "msrt_save_holiday_auth_data";
                var values = "&idndb_holiday_marker=" + checkValues +
                        "&paramid=" + paramid;
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            window.location = "modalsSucess.jsp?desigURL=ndb_holiday_marker_authorization.jsp&message=Holiday marked data authorized successfuly !";

                        } else if (data.systemna) {
                            window.location = "modalsError.jsp?desigURL=ndb_holiday_marker_authorization.jsp&message=" + data.systemna + "";

                        } else if (data.error) {
                            window.location = "modalsError.jsp?desigURL=ndb_holiday_marker_authorization.jsp&message=Error occured in authorizing holiday marked data.";
            ...
            $("#msrt_save_holiday_reject_data").click(function (e) {
                ...
                var paramid = "msrt_save_holiday_reject_data";
                $('input[type="submit"]').prop('disabled', false);
                ...
                $("#msrt_save_holiday_reject_data").prop("disabled", true);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            window.location = "modalsSucess.jsp?desigURL=ndb_holiday_marker_authorization.jsp&message=Holiday marked data rejected successfuly !";

                        } else if (data.systemna) {
                            window.location = "modalsError.jsp?desigURL=ndb_holiday_marker_authorization.jsp&message=" + data.systemna + "";

                        } else if (data.error) {
                            window.location = "modalsError.jsp?desigURL=ndb_holiday_marker_authorization.jsp&message=Error occured in rejecting holiday marked data.";
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Holiday Marker Authorization
                        <small>Holiday Data</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Master Files</a></li>
                        <li class="active">Holiday Marking Authorization</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-danger">
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-info pull-right" id="msrt_save_holiday_reject_data">Rejected</button>
                                    <button type="submit" class="btn btn-info pull-right" id="msrt_save_holiday_auth_data" style="margin-right: 5px">Authorized</button>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body" style="overflow-y: auto;">
                                    <table id="example1" class="table table-bordered table-striped" style="cursor: pointer;">
                                        ...
                                        <tbody>
                                            <%  if (_session_availability) {
                                                    out.print(new FIllDataTableBean().getUnAuthHolidayData(session.getAttribute("userid").toString()));
                                                }
                                            %>
                                        </tbody>
                                        <tfoot>
